...
{
    ui->setupUi(this);
    QPixmap background("C:/Users/Mi  Manchi/Desktop/R-C.jpg");
    QPalette palette;
    palette.setBrush(this->backgroundRole(), QBrush(background.scaled(this->size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation)));
